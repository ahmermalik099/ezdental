...
class _RegisterPatientScreenState extends State<RegisterPatientScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: isLoading ? null : _handlePatientRegister,
                  child: isLoading
  ...
  Future<void> _handlePatientRegister() async {
    ...
    try {
      User? user = await AuthService().registerPatient(emailController.text, passwordController.text);

      await FirestoreService()
          .createUser(emailController.text, lat, long, userController.text, 'patient');
